                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                    <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                        <h1 className="text-4xl font-medium tracking-tight text-gray-900">
                            <span className="block font-medium tracking-tight">Looking for a job?</span>
                            <span className="block text-primary font-medium tracking-tighter">We&apos;re here to help</span>
                        </h1>
                        <p className="mt-4 text-xl text-gray-500">
                            By using our platform, you can find the right job for you.
                                            ...
                                            {features.map((feature) => (
                                                <div key={feature.name} className="relative">
                                                    <dt>
                                                        ...
                                                        <p className="ml-16 text-lg font-medium leading-6 text-secondary-content">{feature.name}</p>
                                                    </dt>
